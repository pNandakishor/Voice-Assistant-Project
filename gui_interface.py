...
def execute_command(command):
    if "hello" in command:
        output_text.set("Hello! How can I help you?")
        speak("Hello! How can I help you?")
    elif "how are you" in command:
        output_text.set("I'm fine, thank you!")
        print("I'm fine, thank you!")
        speak("I'm fine, thank you!")
    elif "what is your name" in command:
        output_text.set("My name is jarvis.")
        print("My name is jarvis.")
        speak("My name is jarvis.")
    elif 'open youtube' in command:
        output_text.set("Here you go to Youtube\n")
    ...
    # pyautogui.hotkey('win', 'l')
        ...
        # Add other command execution logic here...
